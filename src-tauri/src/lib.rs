...
use commands::{
    ...
    list_hooks, list_memories_cmd, list_plugins, list_skills, list_sources, list_tasks,
    rebuild_index, reinit_and_rebuild_index, remove_agent_profile, remove_source,
