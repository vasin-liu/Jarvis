...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 01-01 | 01 | 1 | SHELL-01 | T-01 / — | No new network/shell surfaces | unit/integration | `cargo test --workspace` | ✅ | ✅ green |
| 01-02 | 01 | 1 | FE-01 | — | N/A | build | `npm run build` | ✅ | ✅ green |
| 01-03 | 01 | 2 | QA-01, QA-03 | T-01 | Config write path unchanged | e2e | `npm run test:e2e:local` | ✅ | ✅ green |
