...
- [x] **MCP-01**: External MCP clients can call `search` using the same hybrid retrieval path as in-app agent knowledge search
- [x] **MCP-02**: External MCP clients can call `list_sources` to inventory indexed sources
