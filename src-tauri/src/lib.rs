...
use commands::{
    ...
    compile_wiki_cmd, create_chat_session, delete_chat_session, delete_task, detect_lark_cli,
    export_wiki_zip_cmd, extract_tasks_cmd, forget_memory_cmd, get_api_key_status, get_config,
    get_embedder_readiness, get_index_status, get_memory_content_cmd, get_sync_status, index_file,
    is_e2e_mode_cmd,
    list_agent_profiles, list_chat_messages, list_chat_sessions, list_cursor_transcripts,
    list_hooks, list_memories_cmd, list_plugins, list_skills, list_related_sources, list_sources,
    list_tasks, rebuild_index, reinit_and_rebuild_index, remove_agent_profile, remove_source,
    remove_watch_folder, retry_source, run_insights_all_cmd, run_scheduled_sync_cmd,
    set_active_agent, set_api_key, set_config, source_count, start_ask_e2e, summarize_source_cmd,
    sync_cursor_transcripts_cmd, sync_lark_doc, sync_lark_im, sync_lark_mail, sync_lark_sheet,
    sync_lark_url, update_memory_cmd, update_task_status, upsert_agent_profile,
