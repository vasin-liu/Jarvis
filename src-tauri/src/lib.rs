...
use commands::{
    ...
    extract_tasks_cmd, forget_memory_cmd, get_api_key_status, get_config, get_index_status,
    get_memory_content_cmd, get_sync_status, index_file, is_e2e_mode_cmd, list_agent_profiles,
    list_chat_messages, list_chat_sessions, list_cursor_transcripts, list_hooks, list_memories_cmd,
    list_plugins, list_skills, list_sources, list_tasks, rebuild_index, reinit_and_rebuild_index,
