...
- [ ] **WIKI-03**: User can compile an indexed source into Markdown wiki pages (source summary + entities + concepts) with YAML frontmatter, `[[wikilinks]]`, and `index.md`
...
- [ ] **WIKI-06**: When wiki is enabled, user can trigger “生成笔记” from Library and toggle wiki in Settings; controls are hidden when disabled
